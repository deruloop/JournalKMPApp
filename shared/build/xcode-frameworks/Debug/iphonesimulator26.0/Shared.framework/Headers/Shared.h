...
@class Shared__SkieSuspendWrappersKt, SharedUShort, SharedULong, SharedUInt, SharedUByte, SharedSkie_SuspendResultSuccess, SharedSkie_SuspendResultError, SharedSkie_SuspendResultCanceled, SharedSkie_SuspendResult, SharedSkie_SuspendHandler, SharedSkie_CancellationHandler, SharedSkieKotlinStateFlow<T>, SharedSkieKotlinSharedFlow<T>, SharedSkieKotlinOptionalStateFlow<T>, SharedSkieKotlinOptionalSharedFlow<T>, SharedSkieKotlinOptionalMutableStateFlow<T>, SharedSkieKotlinOptionalMutableSharedFlow<T>, SharedSkieKotlinOptionalFlow<T>, SharedSkieKotlinMutableStateFlow<T>, SharedSkieKotlinMutableSharedFlow<T>, SharedSkieKotlinFlow<T>, SharedSkieColdFlowIterator<E>, SharedShort, SharedPlatform_iosKt, SharedNumber, SharedMutableSet<ObjectType>, SharedMutableDictionary<KeyType, ObjectType>, SharedLong, SharedKotlinThrowable, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinException, SharedKotlinCancellationException, SharedKotlinArray<T>, SharedInt, SharedIOSPlatform, SharedGreeting, SharedFloat, SharedFeatureStateSuccess, SharedFeatureStateLoading, SharedFeatureStateIdle, SharedFeatureStateError, SharedFeatureState, SharedFeatureRepository, SharedDouble, SharedByte, SharedBoolean, SharedBase, NSString, NSSet<ObjectType>, NSObject, NSNumber, NSMutableSet<ObjectType>, NSMutableDictionary<KeyType, ObjectType>, NSMutableArray<ObjectType>, NSError, NSDictionary<KeyType, ObjectType>, NSArray<ObjectType>;

@protocol SharedSkie_DispatcherDelegate, SharedPlatform, SharedKotlinx_coroutines_coreStateFlow, SharedKotlinx_coroutines_coreSharedFlow, SharedKotlinx_coroutines_coreRunnable, SharedKotlinx_coroutines_coreMutableStateFlow, SharedKotlinx_coroutines_coreMutableSharedFlow, SharedKotlinx_coroutines_coreFlowCollector, SharedKotlinx_coroutines_coreFlow, SharedKotlinIterator, NSCopying;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureRepository")))
@interface SharedFeatureRepository : SharedBase
@property (readonly) id<SharedKotlinx_coroutines_coreFlow> dataStream __attribute__((swift_name("dataStream")));
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)fetchDataWithCompletionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetchData(completionHandler:)")));
@end

__attribute__((swift_name("FeatureState")))
@interface SharedFeatureState : SharedBase
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureState.Error")))
@interface SharedFeatureStateError : SharedFeatureState
@property (readonly) NSString *message __attribute__((swift_name("message")));
- (instancetype)initWithMessage:(NSString *)message __attribute__((swift_name("init(message:)"))) __attribute__((objc_designated_initializer));
- (SharedFeatureStateError *)doCopyMessage:(NSString *)message __attribute__((swift_name("doCopy(message:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureState.Idle")))
@interface SharedFeatureStateIdle : SharedFeatureState
@property (class, readonly, getter=shared) SharedFeatureStateIdle *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureState.Loading")))
@interface SharedFeatureStateLoading : SharedFeatureState
@property (class, readonly, getter=shared) SharedFeatureStateLoading *shared __attribute__((swift_name("shared")));
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FeatureState.Success")))
@interface SharedFeatureStateSuccess : SharedFeatureState
...
- (SharedFeatureStateSuccess *)doCopyData:(NSString *)data __attribute__((swift_name("doCopy(data:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@end
...
+ (void)Skie_Suspend__3__fetchDataDispatchReceiver:(SharedFeatureRepository *)dispatchReceiver suspendHandler:(SharedSkie_SuspendHandler *)suspendHandler __attribute__((swift_name("Skie_Suspend__3__fetchData(dispatchReceiver:suspendHandler:)")));
@end
